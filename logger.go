// from https://github.com/apsdehal/go-logger
package logger
...
func (r *InfoS) Output(format string) string {
...
func (w *Worker) Log(level LogLevel, calldepth int, info *InfoS) error {
...
func (info *InfoS) logLevelString() string {
	logLevels := [...]string{
		"CRITICAL",
		"ERROR",
		"WARNING",
